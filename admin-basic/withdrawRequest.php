                                            ...
                                            foreach ($json_data['msg'] as $singleRow): 
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php 
                                                            if($singleRow['User']['paypal'] == "" || $singleRow['User']['paypal'] == null){
                                                                echo "-";
                                                            }else{
                                                                echo $singleRow['User']['paypal'];
                                                            } ?>
                                                        </td>
                                                        <td>
                                                           <?php
                                                                            ...
                                                                            if($singleRow['WithdrawRequest']['status']=="0")
                                                                            {
                                                                                ?>
                                                                                    ...
                                                                                    <li class="more-menu-item" role="presentation">
                                                                                        ...
                                                                                        <!-- <a href=""> -->
                                                                                            <button type="button" onclick="rejectWithdrawRequest('<?php echo $singleRow['WithdrawRequest']['id']; ?>')" class="more-menu-btn" role="menuitem">Reject</button>
                                                                                        <!-- </a> -->
                                                                                    </li>
                                                                                <?php
                                                                            }
